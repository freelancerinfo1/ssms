"""
Starter fabfile for deploying the ssms project.
...
# CHANGEME
env.hosts = ['user@ssms.example.com']
env.code_dir = '/srv/www/ssms'
env.project_dir = '/srv/www/ssms/ssms'
env.static_root = '/srv/www/ssms/static/'
env.virtualenv = '/srv/www/ssms/.virtualenv'
env.code_repo = 'git@github.com:user/{{project_name}}.git'
env.django_settings_module = 'ssms.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/ssms/wsgi.py" % env.code_dir)
