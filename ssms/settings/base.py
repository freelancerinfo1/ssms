...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'ssms.settings.base.custom_show_toolbar',
...
SYSTEM_EMAIL_PREFIX = "[ssms]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_anabond"  # Make this unique to your project.
